<script lang="ts">
	...
	let answers = $state([
		{ id: 0, text: '', correct: false, rationale: '' },
		{ id: 1, text: '', correct: false, rationale: '' },
		{ id: 2, text: '', correct: false, rationale: '' },
		{ id: 3, text: '', correct: false, rationale: '' }
	]);
