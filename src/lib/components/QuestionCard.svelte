<script lang="ts">
	...
	const selectedOption = $derived(currentQuestion?.answerOptions.find(o => o.text === selectedOptionText));
		...
		<div class="bg-white rounded-2xl shadow-xl overflow-hidden">
			...
			<div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b">
				<div class="flex justify-between items-center">
					...
					<span class="px-3 py-1 rounded-full text-xs font-medium {currentQuestion.category === 'CLR' ? 'bg-blue-100 text-blue-700' : currentQuestion.category === 'Mouvement' ? 'bg-green-100 text-green-700' : currentQuestion.category === 'Organisationnel' ? 'bg-purple-100 text-purple-700' : 'bg-amber-100 text-amber-700'}">
			...
			<div class="p-8">
				...
				{#if showFeedback}
					<div class="mt-6 p-4 rounded-lg {selectedOption?.isCorrect ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}">
						<div class="flex items-center justify-between mb-2">
							...
							<div class="flex gap-2">
								...
								>
									<span>💡</span> {showRationale ? 'Masquer explication' : 'Voir explication'}
								</button>
								{#if canSkip}
									<button
